...
for case in cases:
    ...
    test_mask1_path = basepath + case + "/superstructures/CTG_prediction.nii"
    test_mask2_path = basepath + case + "/superstructures/TECTUM.nii"
    test_mask3_path = basepath + case + "/superstructures/SCP_ROSTRAL_prediction.nii"
    test_mask4_path = basepath + case + "/superstructures/CST_prediction.nii"
