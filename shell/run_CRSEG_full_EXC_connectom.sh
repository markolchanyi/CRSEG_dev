...
BASEPATH="/autofs/space/nicc_003/users/olchanyi/data/RESPONSE_PILOT_FULL/sub-TCRc012"
...
python ../CRSEG/trackgen.py \
        ...
        --cropsize 64 \
        --output /autofs/space/nicc_003/users/olchanyi/scratch/sub-TCRc012 \
...
python ../CRSEG/unet_wm_predict.py \
        ...
        --output_path /autofs/space/nicc_003/users/olchanyi/scratch/sub-TCRc012/unet_predictions \
        --lowb_file /autofs/space/nicc_003/users/olchanyi/scratch/sub-TCRc012/lowb_1mm_cropped_norm.nii.gz \
        --fa_file /autofs/space/nicc_003/users/olchanyi/scratch/sub-TCRc012/fa_1mm_cropped_norm.nii.gz \
        --tract_file /autofs/space/nicc_003/users/olchanyi/scratch/sub-TCRc012/tracts_concatenated_1mm_cropped_norm.nii.gz \
...
#        --atlas_lowb_path /autofs/space/nicc_003/users/olchanyi/Atlases/CRSEG_atlas/T2_0.5mm_BRAINSTEM_CROPPED.nii.gz \
...
#        --atlas_wm_seg_path /autofs/space/nicc_003/users/olchanyi/Atlases/CRSEG_atlas/CRSEG_ROIs.nii.gz \
